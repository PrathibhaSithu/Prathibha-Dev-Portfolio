  ...
  return (
    <label className="theme-switch" style={{ fontSize: 'var(--toggle-size)' }}>
      ...
      <div
        ...
        // Base BG and transition are handled by custom CSS classes due to complexity/variables
      >
        ...
        {/* Night-specific Elements (Only visible when checked) */}
        <div className="theme-switch__stars-container absolute text-[var(--stars-color)] left-[0.312em] w-[2.75em] h-auto">
          <svg fill="none" viewBox="0 0 144 55" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
            <path fill="currentColor" d={starPath} clipRule="evenodd" fillRule="evenodd"></path>
          </svg>
        </div>
        ...
        >
          <div className="theme-switch__sun-moon-container relative z-20 m-auto rounded-[var(--container-radius)] bg-[var(--sun-bg)] overflow-hidden pointer-events-auto"
            style={{
              width: 'var(--sun-moon-diameter)',
              height: 'var(--sun-moon-diameter)',
            }}
          >
            {/* Moon (Only visible when checked) */}
